...
Empresas que queiram realizar parceria também devem se cadastrar no sistema, incluindo as vantagens que deseja oferecer e o custo de cada uma dela (em moedas).
...
O sistema deverá ser desenvolvido atendendo aos requisitos apresentados e cumprindo a modelagem produzida nas sprints iniciais do projeto. O repositório GitHub deve estar atualizado, com todas as versões produzidas dos modelos UML e o código final desenvolvido. A avaliação final do projeto levará em consideração os seguintes aspectos:
...
Justificativa das tecnologias utilizadas, explicando o porque do seu uso, paradigma, padrão de projeto utilizado e estrutura de projeto condizente com a tecnologia escolhida.
 

Processo de Desenvolvimento:
Lab03S01: Modelagem do sistema: Diagrama de Casos de Uso, Histórias do Usuário e Diagrama de Classes.

Lab03S02: Modelo ER, Definição e implementação da estratégia de acesso ao banco de dados e CRUDs de aluno e empresa parceira (versão inicial: front-end e comunicação com back-end)

Lab03S03: A ser determinado

Prazo final: 17/10 | Apresentação: 17/10 | Valor total: 20 pontos | Desconto de 1 ponto por dia de atraso.
